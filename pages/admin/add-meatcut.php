...
<?php add_meat()?>
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
                  <select name="commodity" class="form-control select2" required>
                            <option value="">-- Select Commodity --</option>
                                            <?php
                                                $result= $db->query("SELECT type FROM commodity");
    ...
    <div class="item form-group">
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
                  <select name="type" class="form-control select2" required>
                    <option selected="selected" value="">-- Meat Cut Type --</option>

                                              <?php
                                                $result= $db->query("SELECT cut FROM cut_type");
                                                while ($row= $result->fetch_object()) {
                                                    
                                                    echo'<option value="'.$row->cut.'">'.$row->cut.'</option>';
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
                  <select name="code" class="form-control select2" required>
                    <option selected="selected" value="">-- HS Code --</option>
                                              ...
                                              <?php
                                                $result= $db->query("SELECT code FROM hs_code");
                                                while ($row= $result->fetch_object()) {
    ...
    <div class="item form-group">
    <label class="control-label col-md-3 col-sm-3 col-xs-6">Foreign Manufacture Establishment Name Number<span class="required"> *</span></label>
    <div class="col-md-6 col-sm-6 col-xs-12"> 
    ...
    <div class="col-md-6 col-sm-6 col-xs-12"> 
        ...
        <input type="text" name="remarks" class="form-control col-md-7 col-xs-12" >
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
                  <select name="country" class="form-control select2" required>
                    <option value="">-- Select Country of Origin --</option>
                                              ...
                                              <?php
                                                $result= $db->query("SELECT country FROM country");
                                                while ($row= $result->fetch_object()) {
    ...
    <div class="col-md-6 col-sm-6 col-xs-12">
        ...
        <input id="files" type="file"  class="form-control col-md-7 col-xs-12" name="files[]" multiple="" required>
