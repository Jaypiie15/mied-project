...
if(empty($id)){
    ...
    $query = $db->query("SELECT * FROM country WHERE id = '$id'");
...
<hr>
    ...
    <div class="col-md-6 col-sm-6 col-xs-12"> 
        ...
        <input type="text" name="country" value="<?php echo $country?>" class="form-control col-md-7 col-xs-12" >
