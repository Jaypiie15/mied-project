                        ...
                        <div class="modal-header">
                          ...
                          <div class="item form-group">
                            ...
                            <div class="col-md-11 col-sm-6 col-xs-12">
                              ...
                              <input type="text" name="kind" class="form-control col-md-7 col-xs-12" value="'.$kind.'" readonly>
                          </div>
                          </div>
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="text" name="cut" class="form-control col-md-7 col-xs-12" value="'.$cut.'" readonly>
                            </div>
                          </div>
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="text" name="name" class="form-control col-md-7 col-xs-12" value="'.$name.'" readonly>
                            </div>
                          </div>
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="text" name="rema" class="form-control col-md-7 col-xs-12" value="'.$rema.'" readonly>
                            </div>
                          </div>
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="text" name="coun" class="form-control col-md-7 col-xs-12" value="'.$coun.'" readonly>
                            </div>
                          </div>
                          <input type="hidden" name="id" value="'.$ids.'">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                            <button type="button" class="btn btn-danger btn-block btn-flat disabled">Only Admin Can Update</button>
                            </div>
                            </div>
